...
- [ ] Проработать отчёт аудита кода `docs/audits/2026-07-19-project-audit-report.md` (53/60 закрыто; CONV-1 — декомпозиция `RecipesView.tsx` завершена по плану `docs/audits/conv-1-decomposition-plan.md`; PERF-1 исправлена; осталось: PERF-2…8)
