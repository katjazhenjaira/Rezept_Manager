...
- [ ] Проработать отчёт аудита кода `docs/audits/2026-07-22-project-audit-report.md` (39 находок: 2 критических, 6 противоречий с документацией, 3 недокументированных, 10 логических, 6 dead code, 4 TypeScript, 2 конвенции, 1 perf, 5 по тестовому покрытию). Разбито на 13 групп по файловой локальности — план и порядок в `docs/plans/2026-07-22-audit-followup-groups.md`, текущий статус — таблица «Прогресс проработки» в начале самого отчёта
