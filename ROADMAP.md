...
- [ ] Проработать отчёт аудита кода `docs/audits/2026-07-19-project-audit-report.md` (54/60 закрыто; CONV-1 — декомпозиция `RecipesView.tsx` завершена по плану `docs/audits/conv-1-decomposition-plan.md`; PERF-1, PERF-3 исправлены; PERF-2 отложена, см. отдельный пункт ниже; осталось: PERF-4…8)
