        ...
        <div className="fixed inset-0 z-[90] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="p-6 border-b border-zinc-100 flex items-center justify-between bg-white sticky top-0 z-10">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <h2 className="text-xl font-bold text-zinc-900">Программа: {program.name}</h2>
                  ...
                  <div className="flex flex-wrap gap-2 mt-3">
                    ...
                    <div className="relative">
                      <button
                        onClick={() =>
                          setProgramAddRecipeDropdown(
                            programAddRecipeDropdown?.subfolderId === 'main'
                              ? null
                              : { programId: program.id, subfolderId: 'main' },
                          )
                        }
                      ...
                      <AnimatePresence>
                        {programAddRecipeDropdown?.programId === program.id &&
                          programAddRecipeDropdown?.subfolderId === 'main' && (
                            <>
                              <div
                              ...
                              >
                                <AddRecipeOption
                                  ...
                                  onClick={() => {
                                    onStartRecipeSelection(program.id, 'main');
                                    setProgramAddRecipeDropdown(null);
                                  }}
                                />
                                <AddRecipeOption
                  ...
                  {program.resources && (
                    <div className="flex flex-wrap gap-2 mt-3">
                      {program.resources?.map((res) => (
                        <div
                          key={res.id}
                          className="flex items-center gap-2 bg-zinc-50 border border-zinc-100 px-2 py-1 rounded-md group relative"
                        >
                          {res.type === 'pdf' ? (
                          ...
                          <a
                            ...
                            className="text-[10px] font-medium text-zinc-600 hover:text-emerald-600 truncate max-w-[120px]"
                          >
                            {res.title}
                          </a>
                          {res.description && (
                  ...
                  {(() => {
                    const hasRestrictions =
                      (program.allowedProducts?.length ?? 0) > 0 ||
                      (program.forbiddenProducts?.length ?? 0) > 0;
                            ...
                            <button
                              onClick={() =>
                                void addProductsToCart([
                                  ...(program.allowedProducts || []),
                                  ...(program.forbiddenProducts || []),
                                ])
                              }
                          ...
                          {showProducts && (
                            ...
                            >
                              <div className="flex flex-col gap-3 mt-1">
                                  ...
                                  <div className="bg-emerald-50/50 rounded-xl p-3 border border-emerald-100">
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                      {program.allowedProducts.map((p, i) => (
                                        <span
                                          key={i}
                                          className="text-[10px] bg-white text-emerald-700 px-2 py-0.5 rounded-md border border-emerald-100"
                                        >
                                          {p}
                                        </span>
                                      ))}
                                ...
                                {program.forbiddenProducts &&
                                  program.forbiddenProducts.length > 0 && (
                                    <div className="bg-red-50/50 rounded-xl p-3 border border-red-100">
                                      ...
                                      <div className="flex flex-wrap gap-1.5">
                                        {program.forbiddenProducts.map((p, i) => (
                                          <span
                                            key={i}
                                            className="text-[10px] bg-white text-red-700 px-2 py-0.5 rounded-md border border-red-100"
                                          >
                                            {p}
                                          </span>
                                        ))}
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar flex-1">
              {(() => {
                const collectionRecipes = recipes.filter(
                  (r) =>
                ...
                return (
                  <div className="space-y-12">
                          ...
                          return (
                            <div
                              ...
                              onDrop={(e: React.DragEvent<HTMLDivElement>) => {
                                ...
                                const sourceSubfolderId =
                                  e.dataTransfer.getData('sourceSubfolderId');
                            ...
                            >
                                    ...
                                    <div className="relative">
                                      <button
                                        onClick={(e) => {
                                          e.stopPropagation();
                                          setProgramAddRecipeDropdown(
                                            programAddRecipeDropdown?.subfolderId === subfolder.id
                                              ? null
                                              : {
                                                  programId: program.id,
                                      ...
                                      >
                                        <Plus className="w-3 h-3" />+ Рецепт
                                      </button>

                                      <AnimatePresence>
                                        {programAddRecipeDropdown?.programId === program.id &&
                                          programAddRecipeDropdown?.subfolderId ===
                                            subfolder.id && (
                                            <>
                                              <div
                                                className="fixed inset-0 z-40"
                                  ...
                                  {subfolder.resources && subfolder.resources.length > 0 && (
                                    <div className="flex flex-wrap gap-1.5 mt-2">
                                      {subfolder.resources.map((res) => (
                                        <div
                                          key={res.id}
                                          className="flex items-center gap-1.5 bg-white/40 border border-emerald-100 px-1.5 py-0.5 rounded-md group relative"
                                          onClick={(e) => e.stopPropagation()}
                                        >
                                          {res.type === 'pdf' ? (
                                            <FileText className="w-2.5 h-2.5 text-red-500" />
                                          ) : (
                                            <LinkIcon className="w-2.5 h-2.5 text-blue-500" />
                                          )}
                                          <a
                                            href={res.url}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="text-[9px] font-medium text-emerald-800 hover:underline truncate max-w-[80px]"
                                          >
                                            {res.title}
                                          </a>
                                          {res.description && (
                              ...
                              {isOpen &&
                              (subfolder.allowedProducts?.length ||
                                subfolder.forbiddenProducts?.length) ? (
                                <div className="px-4 pb-4">
                                  <div className="flex items-center justify-between mb-2">
                                    <p className="text-[10px] font-bold text-zinc-500 uppercase">
                                      Ограничения подпапки
                                    </p>
                                    <div className="flex items-center gap-2">
                                      <button
                                        onClick={(e) => {
                                          e.stopPropagation();
                                          void addProductsToCart([
                                            ...(subfolder.allowedProducts || []),
                                            ...(subfolder.forbiddenProducts || []),
                                          ]);
                                        }}
                                  ...
                                  <div className="flex flex-col gap-2">
                                    {subfolder.allowedProducts &&
                                      subfolder.allowedProducts.length > 0 && (
                                        <div className="bg-emerald-50/30 rounded-lg p-2 border border-emerald-100/50">
                                          ...
                                          <div className="flex flex-wrap gap-1">
                                            {subfolder.allowedProducts.map((p, i) => (
                                              <span
                                                key={i}
                                                className="text-[8px] bg-white text-emerald-700 px-1.5 py-0.5 rounded border border-emerald-100"
                                              >
                                                {p}
                                              </span>
                                            ))}
                                    ...
                                    {subfolder.forbiddenProducts &&
                                      subfolder.forbiddenProducts.length > 0 && (
                                        <div className="bg-red-50/30 rounded-lg p-2 border border-red-100/50">
                                          ...
                                          <div className="flex flex-wrap gap-1">
                                            {subfolder.forbiddenProducts.map((p, i) => (
                                              <span
                                                key={i}
                                                className="text-[8px] bg-white text-red-700 px-1.5 py-0.5 rounded border border-red-100"
                                              >
                                                {p}
                                              </span>
                                            ))}
                                      ...
                                      {subfolderRecipes.length > 0 ? (
                                          ...
                                          {subfolderRecipes.map((recipe) => (
                                            ...
                                            >
                                              {recipeHasAllergens(
                                                ...
                                                <div
                                                  className="absolute -top-1 -right-1 z-10 bg-red-500 text-white p-1 rounded-full shadow-sm"
                                              ...
                                              <div className="w-16 h-16 bg-zinc-100 rounded-xl overflow-hidden flex-shrink-0">
                                                <img
                                                  src={
                                                    recipe.image ||
                                                    `https://picsum.photos/seed/${recipe.id}/200/200`
                                                  }
                                                  alt={recipe.title}
                                              ...
                                              <div className="flex-1 min-w-0">
                                                <h3 className="font-bold text-sm text-zinc-900 truncate group-hover:text-emerald-600 transition-colors">
                                                  {recipe.title}
                                                </h3>
                                        ...
                                        <div className="py-8 text-center bg-white/50 rounded-2xl border border-dashed border-emerald-200">
                                          <p className="text-emerald-400 text-xs italic">
                                            В этой подпапке пока нет рецептов
                                          </p>
                                        </div>
                                      )}
                                    </div>
                                    ...
                                    {collectionRecipes.map((recipe) => (
                                      ...
                                      >
                                        ...
                                        <div className="p-5 flex-1 flex flex-col">
                                          <h3 className="font-bold text-lg mb-2 group-hover:text-emerald-600 transition-colors line-clamp-2 leading-snug">
                                            {recipe.title}
                                          </h3>
                    ...
                    {collectionRecipes.length === 0 &&
                      (!program.subfolders ||
                        program.subfolders.length === 0 ||
                        (programRecipeFilter !== 'Все' &&
                          !program.subfolders.some(
                            (sf) =>
                              recipes.filter(
                                (r) =>
                                  sf.recipeIds.includes(r.id) &&
                                  r.categories.includes(programRecipeFilter),
                              ).length > 0,
                          ))) && (
              ...
              <div className="p-6 overflow-y-auto custom-scrollbar flex-1 space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-4 pt-4 border-t border-zinc-100">
                    <div>
                      <label className="block text-xs font-bold text-zinc-400 uppercase mb-1">
                        Разрешенные продукты (через запятую)
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-xs font-bold text-zinc-400 uppercase mb-1">
                        Запрещенные продукты (через запятую)
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="space-y-2">
                      {editFormData.resources.length === 0 ? (
                        ...
                        editFormData.resources.map((res) => (
                          <div
                            key={res.id}
                            className="flex items-center justify-between bg-zinc-50 p-2 rounded-lg border border-zinc-100"
                          >
              ...
              <div className="p-6 border-t border-zinc-100 bg-zinc-50 flex gap-3">
                {editingEntity.type === 'subfolder' && (
                  <button
                    onClick={() => {
                      setSubfolderToDelete({
                        programId: editingEntity.programId!,
                        subfolderId: editingEntity.id,
                        name: editFormData.name,
                      });
                      setEditingEntity(null);
                    }}
                    ...
                    onClick={async () => {
                      ...
                      const newResource: Resource = {
                        ...
                        title:
                          ...
                          (activeResourceForm.type === 'link' ? 'Ссылка' : 'Документ'),
          ...
          <div className="fixed inset-0 z-[130] flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-zinc-500 text-sm mb-6">
                Действительно хочешь удалить подпапку{' '}
                <span className="font-bold text-zinc-900">"{subfolderToDelete.name}"</span>?
              </p>
                ...
                <button
                  onClick={async () => {
                    await programsRepo.update(subfolderToDelete.programId, {
                      subfolders: program.subfolders?.filter(
                        (sf) => sf.id !== subfolderToDelete.subfolderId,
                      ),
                    });
